...
- 建议来源：基金标的与操作建议由程序按公开行情和历史走势规则化生成，已在文档中标注来源，非人工投顾判断。
...
项目内置 GitHub Actions 定时工作流 `.github/workflows/daily_report.yml`，周一至周五 06:05 UTC（北京时间 14:05）在 GitHub 云端自动执行：
